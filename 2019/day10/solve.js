...
(function() {
  var AsteroidField, PolarAsteroids, ans, findGCD, fs, input, one, out, start, two;
  ...
  AsteroidField = (function() {
    ...
    AsteroidField.prototype._findAsteroids = function() {
    ...
    AsteroidField.prototype.print = function() {
    ...
    AsteroidField.prototype.asteroidWouldBlock = function(start, ex) {
    ...
    AsteroidField.prototype.otherAsteroids = function(thisOne) {
    ...
    AsteroidField.prototype.isSame = function(a, b) {
      return a[0] === b[0] && a[1] === b[1];
    };

    AsteroidField.prototype.solve = function() {
      ...
      for (j = 0, len = ref.length; j < len; j++) {
        ...
        for (l = 0, len2 = ref2.length; l < len2; l++) {
          o = ref2[l];
          if (!blockedVis.some((function(_this) {
            return function(z) {
              return _this.isSame(o, z);
            };
          })(this))) {
            view++;
          }
      ...
      most = Array.from(count.entries()).reduce((function(_this) {
        return function(high, k_v) {
          if (k_v[1] > high[1]) {
            return k_v;
          } else {
            return high;
  ...
  PolarAsteroids = (function() {
    function PolarAsteroids(af, coordinate) {
    ...
    PolarAsteroids.prototype.solve = function() {
      var ang, angle, angles, asteroidDestroyed, coordinate, coordinates, distance, i, j, k, l, len, len1, len2, len3, m, nxt, q, r, ref, ref1, ref2, ref3, ref4, ref5, rotation, x, y;
      coordinates = [];
      ref = this.xlate.keys();
      for (coordinate of ref) {
        ref1 = JSON.parse(coordinate), distance = ref1[0], x = ref1[1], y = ref1[2];
        if (x !== 0 || y !== 0) {
      ...
      for (j = 0, len = coordinates.length; j < len; j++) {
        ref2 = coordinates[j], distance = ref2[0], x = ref2[1], y = ref2[2];
        if (x >= 0) {
          rotation[0].set(y / x, []);
        } else {
          rotation[1].set(y / x, []);
      ...
      angles[0].sort((function(_this) {
        return function(a, b) {
          return b - a;
        };
      })(this));
      angles[1].sort((function(_this) {
        return function(a, b) {
          return a - b;
        };
      })(this));
      for (k = 0, len1 = coordinates.length; k < len1; k++) {
        ref3 = coordinates[k], distance = ref3[0], x = ref3[1], y = ref3[2];
        if (x >= 0) {
      ...
      for (i = l = 0; l <= 1; i = ++l) {
        ...
        for (m = 0, len2 = ref4.length; m < len2; m++) {
          ang = ref4[m];
          rotation[i].get(ang).sort((function(_this) {
            return function(a, b) {
              return a[0] - b[0];
            };
          })(this));
